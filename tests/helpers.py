...
def load_space_hulk(path_to_space_hulk: Path = Path("space_hulk_for_test.json")) -> SpaceHulk:
    return SpaceHulk.parse_file(path_to_space_hulk)


def load_layout(path_to_layout: Path = Path("space_hulk_layout_for_test.pickle")) -> LayoutGraph:
