...
flowchart LR
    ...
    specialCorridor --"6\n(p=0.14)"--> corridorTurn_with_corner_symL["corridorTurn_with_corner_symL\n(pTotal=0.035)"]
    specialCorridor --"7\n(p=0.16)"--> corridorCornered_overlapping2_symF["corridorCornered_overlapping2_symF\n(pTotal=0.04)"]
    ...
    specialCorridor --"10\n(p=0.08)"--> corridorCornered_overlapping3_symF["corridorCornered_overlapping3_symF\n(pTotal=0.02)"]
    ...
    intersection --"6\n(p=0.14)"--> intersection3way_with_corner_symE["intersection3way_with_corner_symE\n(pTotal=0.0467)"]
    intersection --"7\n(p=0.16)"--> intersection4wayAsym_overlapping1_symF["intersection4wayAsym_overlapping1_symF\n(pTotal=0.0533)"]
